...
class RandomDataProvider(DataProvider):
    ...
    def _get_one_real_time_price_from_local_variable_hist(self, security, timeNow, tickType, freq='dummy'):
    ...
    def provide_historical_data_from_local_variable_hist(self, security, endTime, goBack, barSize, whatToShow, useRTH, formatDate):
        ...
        """
        self._log.debug(__name__ + '::get_historical_data: security=%s endTime=%s goBack=%s barSze=%s whatToShow=%s useRTH=%s formatDate=%s' % (security.full_print(), endTime, goBack, barSize, whatToShow, useRTH, formatDate))
    ...
    def provide_hist_from_a_true_dataProvider(self, security, endTime, goBack, barSize, whatToShow, useRTH, formatDate):
        ...
        # print(__name__ + '::provide_hist_from_a_true_dataProvider')
        # return self.provide_historical_data_from_local_variable_hist(security, endTime, goBack, barSize, whatToShow, useRTH, formatDate)
