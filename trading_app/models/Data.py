...
class DataFromServer(object):
    ...
    def get_value(self, security, tickType, fieldName):
        ...
        elif tickType in [IBCpp.TickType.ASK_OPTION_COMPUTATION, IBCpp.TickType.BID_OPTION_COMPUTATION, IBCpp.TickType.LAST_OPTION_COMPUTATION, IBCpp.TickType.MODEL_OPTION]:
